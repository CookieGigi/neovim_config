...
-- Configure typescript-language-server for TypeScript/JavaScript/React
-- Required external dependency: typescript-language-server (install via npm install -g typescript-language-server)
